...
const { getAllCustomerAPI, postCreateCustomerAPI, uploadFile, upLoadMultipleFiles, postCreateBulkCustomer, putUpdateCustomer, deleteACustomer } = require('../controllers/customer.controller');
